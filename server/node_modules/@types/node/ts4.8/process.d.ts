    ...
    global {
        ...
        namespace NodeJS {
            ...
            interface Process extends EventEmitter {
                 ...
                 * Node.js and its dependencies. `process.versions.models` indicates the current
                 * ABI version, which is increased whenever a C++ API changes. Node.js will refuse
                 * to load models that were compiled against a different module ABI version.
                 *
                 * ```js
                 ...
                 * models in the ecosystem that are known to extend, modify, or entirely replace
                 ...
                 * models that were required before the change occurred. Generally, it's
